 ...
 * their own private state. The lifecycle methods {@link #initialize initialize()} and {@link #shutdown
 * shutdown()} are for managing per-container context, and {@link #startExecution startExecution()} and
 * {@link #finishExecution finishExecution()} are for per-execution context. An "execution" happens with
 ...
 * static method invocations that provide a unique symbolic key, etc.
 */
